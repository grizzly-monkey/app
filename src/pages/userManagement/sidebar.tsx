...
const UserSidebar = () => {
  ...
  const deleteUserError = useSelector((state) =>
    selectError(state, UserActions.DELETE_USER)
  );
  const deleteUserLoading = useSelector((state) =>
  ...
  return (
    <SideBar isOpen={!!selectedUser}>
      <div style={{ padding: "20px 20px", width: "100%" }}>
        ...
        <Divider />
        {!!updateUserFirstNameError && (
          <FullAlertError error={updateUserFirstNameError} />
        )}
        {!!updateUserLastNameError && (
          <FullAlertError error={updateUserLastNameError} />
        )}
        {!!updateUserRolesError && (
          <FullAlertError error={updateUserRolesError} />
        )}
